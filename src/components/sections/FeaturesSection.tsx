...
export const FeaturesSection = () => {
    return (
        <section className="py-16 bg-white sm:py-24 lg:py-32 border-b border-gray-100">
                ...
                <div className="text-center">
                    <FadeIn>
                        ...
                        <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-inter">
                            Streamlined processes efficiently from manpower deployment to project handover.
                        </p>
                    </FadeIn>
                </div>

                <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 lg:grid-cols-4 md:gap-0 xl:mt-24">
